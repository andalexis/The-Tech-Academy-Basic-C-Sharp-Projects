...
namespace Casino.TwentyOne
{
    public class TwentyOneGame : Game, IWalkAway
    {
        ...
        public override void Play()  //encompasses one Hand of the 21 game
        {
            Dealer = new TwentyOneDealer();
            foreach (Player player in Players)
            {
                player.Hand = new List<Card>();
                player.Stay = false; // reseting players
            }
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                foreach (Player player in Players)
                {
                    ...
                    if (i == 1) // on second round ofpassing cards
                    {
            ...
            foreach (Player player in Players) // comparing player hand to dealer hand
            {
